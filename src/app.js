...
class App extends Component {
  ...
  config = {
    pages: [
      ...
      'pages/personalCenter/personalData/index',
      'pages/personalCenter/changeNickName/index',
      'pages/personalCenter/changeName/index',
      'pages/personalCenter/changeGender/index',
      'pages/personalCenter/changeIdNum/index',
